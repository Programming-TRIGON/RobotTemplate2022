...
public class GenericTurnToTargetCMD extends CommandBase {
    ...
    public GenericTurnToTargetCMD(
        ...
        PIDCoefs rotationSettings = RobotConstants.VisionConstants.ROTATION_SETTINGS;
    ...
    public boolean isFinished() {
        return ((Timer.getFPGATimestamp() - lastTimeSeenTarget) > RobotConstants.VisionConstants.TARGET_TIME_OUT)
