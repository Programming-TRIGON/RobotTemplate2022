...
public class RobotComponents {
    ...
    protected static class SwerveComponents {
        ...
        public static final PIDFTalonFX FRONT_LEFT_ANGLE_MOTOR = new PIDFTalonFX(
                RobotMap.CAN.Swerve.FRONT_LEFT_ANGLE_MOTOR_ID, ANGLE_MOTOR_CONFIG.withPID(
                        LOCAL_SWERVE_MODULES.frontLeftModuleConstants.angleCoefs).
                withRemoteSensorSource(
                        RobotMap.CAN.Swerve.FRONT_LEFT_ANGLE_MOTOR_ID, RemoteSensorSource.TalonSRX_SelectedSensor));
        public static final PIDFTalonFX FRONT_LEFT_DRIVE_MOTOR = new PIDFTalonFX(
                RobotMap.CAN.Swerve.FRONT_LEFT_DRIVE_MOTOR_ID, DRIVE_MOTOR_CONFIG.withPID(
        ...
        public static final TrigonTalonSRX FRONT_LEFT_ENCODER = new TrigonTalonSRX(
                RobotMap.CAN.Swerve.FRONT_LEFT_ANGLE_ENCODER_ID, ANGLE_ENCODER_CONFIG);

        /* Front Right */
        public static final PIDFTalonFX FRONT_RIGHT_ANGLE_MOTOR = new PIDFTalonFX(
                RobotMap.CAN.Swerve.FRONT_RIGHT_ANGLE_MOTOR_ID, ANGLE_MOTOR_CONFIG.
                withPID(LOCAL_SWERVE_MODULES.frontRightModuleConstants.angleCoefs).
                withRemoteSensorSource(
                        RobotMap.CAN.Swerve.FRONT_RIGHT_ANGLE_MOTOR_ID, RemoteSensorSource.TalonSRX_SelectedSensor));
        public static final PIDFTalonFX FRONT_RIGHT_DRIVE_MOTOR = new PIDFTalonFX(
                RobotMap.CAN.Swerve.FRONT_RIGHT_DRIVE_MOTOR_ID, DRIVE_MOTOR_CONFIG.withPID(
        ...
        public static final TrigonTalonSRX FRONT_RIGHT_ENCODER = new TrigonTalonSRX(
                RobotMap.CAN.Swerve.FRONT_RIGHT_ANGLE_ENCODER_ID, ANGLE_ENCODER_CONFIG);

        /* Rear Left */
        public static final PIDFTalonFX REAR_LEFT_ANGLE_MOTOR = new PIDFTalonFX(
                RobotMap.CAN.Swerve.REAR_LEFT_ANGLE_MOTOR_ID, ANGLE_MOTOR_CONFIG.
                withPID(LOCAL_SWERVE_MODULES.rearLeftModuleConstants.angleCoefs).
                withRemoteSensorSource(
                        RobotMap.CAN.Swerve.REAR_LEFT_ANGLE_MOTOR_ID, RemoteSensorSource.TalonSRX_SelectedSensor));
        public static final PIDFTalonFX REAR_LEFT_DRIVE_MOTOR = new PIDFTalonFX(
                RobotMap.CAN.Swerve.REAR_LEFT_DRIVE_MOTOR_ID, DRIVE_MOTOR_CONFIG.
        ...
        public static final TrigonTalonSRX REAR_LEFT_ENCODER = new TrigonTalonSRX(
                RobotMap.CAN.Swerve.REAR_LEFT_ANGLE_ENCODER_ID, ANGLE_ENCODER_CONFIG);

        /* Rear Right */
        public static final PIDFTalonFX REAR_RIGHT_ANGLE_MOTOR = new PIDFTalonFX(
                RobotMap.CAN.Swerve.REAR_RIGHT_ANGLE_MOTOR_ID, ANGLE_MOTOR_CONFIG.
                withPID(LOCAL_SWERVE_MODULES.rearRightModuleConstants.angleCoefs).
                withRemoteSensorSource(
                        RobotMap.CAN.Swerve.REAR_RIGHT_ANGLE_MOTOR_ID, RemoteSensorSource.TalonSRX_SelectedSensor));
        public static final PIDFTalonFX REAR_RIGHT_DRIVE_MOTOR = new PIDFTalonFX(
                RobotMap.CAN.Swerve.REAR_RIGHT_DRIVE_MOTOR_ID, DRIVE_MOTOR_CONFIG.withPID(
        ...
        public static final TrigonTalonSRX REAR_RIGHT_ENCODER = new TrigonTalonSRX(
                RobotMap.CAN.Swerve.REAR_RIGHT_ANGLE_ENCODER_ID, ANGLE_ENCODER_CONFIG);
    }
}
